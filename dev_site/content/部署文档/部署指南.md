...
login_url | string | 账号系统认证 url | http://192.168.7.26:8086/mock/24/account/regiserHall | | 具体配置联系运维开发组
...
配置项 | 类型 | 作用 | 默认值 | 示例 |备注 
----- | ---- |-------- | ----- | ----- | ------
account_info_url | string | 获取账号信息的url | http://192.168.7.26:8086/mock/24/account/getByGuid | | 具体配置联系运维开发组
send_code_url | string | 发送验证码 url | http://192.168.7.26:8086/mock/24/account/sendCode |  | 具体配置联系运维开发组
check_code_url | string | 校验验证码 url | http://192.168.7.26:8086/mock/24/account/checkCode | | 具体配置联系运维开发组
bind_phone_url | string | 绑定手机 url | http://192.168.7.26:8086/mock/24/account/bindPhone | | 具体配置联系运维开发组
change_phone_url | string | 修改手机 url | http://192.168.7.26:8086/mock/24/account/resetPhone | | 具体配置联系运维开发组
change_password_url | string | 修改密码 url | http://192.168.7.26:8086/mock/24/account/resetPwd | | 具体配置联系运维开发组
reset_password_url | string | 重置密码 url | http://192.168.7.26:8086/mock/24/account/resetPwd | | 具体配置联系运维开发组
check_password_url | string | 校验密码 url | http://192.168.7.26:8086/mock/24/account/checkPwd | | 具体配置联系运维开发组
