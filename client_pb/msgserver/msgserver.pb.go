...
func (*MsgSvrGetHorseRaceReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_msgserver_337a56532dde6e89, []int{0}
}
...
func (*MsgSvrGetHorseRaceRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_msgserver_337a56532dde6e89, []int{1}
}
...
func (*MsgSvrHorseRaceUpdateNtf) Descriptor() ([]byte, []int) {
	return fileDescriptor_msgserver_337a56532dde6e89, []int{2}
}
func (m *MsgSvrHorseRaceUpdateNtf) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MsgSvrHorseRaceUpdateNtf.Unmarshal(m, b)
}
func (m *MsgSvrHorseRaceUpdateNtf) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MsgSvrHorseRaceUpdateNtf.Marshal(b, m, deterministic)
}
func (dst *MsgSvrHorseRaceUpdateNtf) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSvrHorseRaceUpdateNtf.Merge(dst, src)
}
func (m *MsgSvrHorseRaceUpdateNtf) XXX_Size() int {
	return xxx_messageInfo_MsgSvrHorseRaceUpdateNtf.Size(m)
}
func (m *MsgSvrHorseRaceUpdateNtf) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSvrHorseRaceUpdateNtf.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSvrHorseRaceUpdateNtf proto.InternalMessageInfo
...
func init() { proto.RegisterFile("msgserver.proto", fileDescriptor_msgserver_337a56532dde6e89) }

var fileDescriptor_msgserver_337a56532dde6e89 = []byte{
