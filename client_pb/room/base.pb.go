...
type RoomPlayerInfo struct {
	...
	ShowUid          *int64                  `protobuf:"varint,6,opt,name=show_uid,json=showUid" json:"show_uid,omitempty"`
	Quited           *bool                   `protobuf:"varint,7,opt,name=quited" json:"quited,omitempty"`
...
func (m *RoomPlayerInfo) GetShowUid() int64 {
...
func (m *RoomPlayerInfo) GetQuited() bool {
	if m != nil && m.Quited != nil {
		return *m.Quited
	}
	return false
}

func (m *RoomPlayerInfo) GetGender() uint32 {
...
func (m *RoomPlayerInfo) GetAvatar() string {
...
var fileDescriptor0 = []byte{
	...
	,
}
